                ...
                <div className="flex flex-col h-full py-5 justify-between">
                  <div>
                    ...
                    <div className="px-6 py-2 space-y-3.5">
                      <p className="text-[9px] text-gray-600 font-bold tracking-widest uppercase mb-1">
                        System Status
                      </p>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      {!user && (
                        <Button
                          ...
                          title="Sign in"
                          className="text-gray-400 hover:text-indigo-400 hover:bg-indigo-500/10 cursor-pointer"
                        >
                      ...
                      {user && (
                        <Button
                          ...
                          title="Sign out"
                          className="text-gray-400 hover:text-rose-400 hover:bg-rose-500/10 cursor-pointer"
                        >
